...
public class HerbsAdapter extends RecyclerView.Adapter<HerbsAdapter.HerbsOnClickViewHolder> {
    ...
    public HerbsAdapter(Context context, List<String> plant_titles, List<String> plant_sci_names, List<Integer> plant_images, List<String> plant_desc
            ,List<String> plant_type) {
    ...
    @NonNull
    @Override
    public HerbsAdapter.HerbsOnClickViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.explore_onclick_griditem, parent, false);
        return new HerbsAdapter.HerbsOnClickViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull HerbsAdapter.HerbsOnClickViewHolder holder, int position) {
    ...
    public class HerbsOnClickViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {

        CircleImageView plant_circle_image;
        TextView plant_title_tv, plant_sci_tv;

        public HerbsOnClickViewHolder(@NonNull View itemView) {
            super(itemView);
