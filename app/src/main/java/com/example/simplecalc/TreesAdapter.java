...
public class TreesAdapter extends RecyclerView.Adapter<TreesAdapter.TressOnClickViewHolder> {

    Context context;
    List<String> plant_titles;
    List<String> plant_sci_names;
    List<Integer> plant_images;
    List<String> plant_desc;
    List<String> plant_type;


    public TreesAdapter(Context context, List<String> plant_titles, List<String> plant_sci_names, List<Integer> plant_images, List<String> plant_desc,  List<String> plant_type) {
    ...
    @NonNull
    @Override
    public TreesAdapter.TressOnClickViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.explore_onclick_griditem, parent, false);
        return new TreesAdapter.TressOnClickViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull TreesAdapter.TressOnClickViewHolder holder, int position) {
    ...
    public class TressOnClickViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {

        CircleImageView plant_circle_image;
        TextView plant_title_tv, plant_sci_tv;

        public TressOnClickViewHolder(@NonNull View itemView) {
            super(itemView);
